...
const REACTIONS = {
  'Jiya 🧸': [
    { sender: 'Jiya 🧸', color: '#eb5528', text: 'wow. you really think it was me?' },
    { sender: 'Jiya 🧸', color: '#eb5528', text: 'i literally shared something personal and got leaked' },
    { sender: 'Jiya 🧸', color: '#eb5528', text: "and now i'm the suspect too??" },
    { sender: 'Jiya 🧸', color: '#eb5528', text: 'cool. cool cool cool. 🥺' },
    { sender: 'Arjun 😎', color: '#64748b', text: "that's cold bro" },
    { sender: 'Meera 💅', color: '#ec4899', text: 'bestie... interesting choice. very interesting. 🤔' },
  ],
  'Arjun 😎': [
    ...
    { sender: 'Arjun 😎', color: '#64748b', text: 'this is discrimination against people who nap' },
    { sender: 'Jiya 🧸', color: '#eb5528', text: 'i mean... he does sleep a lot 😭' },
    { sender: 'Meera 💅', color: '#ec4899', text: 'bestie... interesting choice. very interesting. 🤔' },
  ],
  'Meera 💅': [
    { sender: 'Meera 💅', color: '#ec4899', text: 'me?? ME???' },
    { sender: 'Meera 💅', color: '#ec4899', text: "after everything i've done for this group??" },
    { sender: 'Meera 💅', color: '#ec4899', text: 'i CREATED this group' },
    { sender: 'Meera 💅', color: '#ec4899', text: 'i NAMED this group' },
    { sender: 'Meera 💅', color: '#ec4899', text: 'i am the GROUP' },
    { sender: 'Meera 💅', color: '#ec4899', text: 'this is betrayal at the highest level' },
    { sender: 'Jiya 🧸', color: '#eb5528', text: 'meera calm down 😭' },
    { sender: 'Arjun 😎', color: '#64748b', text: 'lol' },
    { sender: 'Meera 💅', color: '#ec4899', text: "and you know what. fine. you think it's me. cool. let's see about that. 🤔" },
  ],
};
...
export default function RevealGroupReaction({ theme, chosenSuspect, onComplete }) {
  ...
  return (
    <div style={{ height:'100vh', display:'flex', flexDirection:'column', background:'#0b141a', color:'#e9edef' }}>
      {/* Header */}
      <div style={{ padding:'12px 16px', background:'#202c33', display:'flex', alignItems:'center', gap:'12px', borderBottom:'1px solid #222e35' }}>
